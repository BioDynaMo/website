            ...
            <Layout mainClass="bg-whitegrey-l2 pb-vw3" bodyClass="bg-white">
                ...
                <div className={`${Spirit.page.xl} mt-vw3`}>
                    ...
                    <section className="grid-12 gutter-row-20 gutter-20-ns gutter-36-l">
                        ...
                        <SetupBox to="/biodynamo/doc/dev_guide/docs/" title="Developer Guide" icon="ubuntu-logo" iconClass="w9 h9" headingClass="mt2">
                            <p className={`${Spirit.small} mw70`}>
                                How to build BioDynaMo.
                            </p>
                        </SetupBox>

                        <SetupBox href="/bioapi" title="API Reference" icon="book-open-solid" iconClass="w9 h9" headingClass="mt2">
                            <p className={`${Spirit.small} mw70`}>
